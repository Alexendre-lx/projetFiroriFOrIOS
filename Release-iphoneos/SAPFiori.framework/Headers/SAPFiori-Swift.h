...
/// :nodoc:
SWIFT_CLASS("_TtC8SAPFiori24FUICalendarFloorplanView")
@interface FUICalendarFloorplanView : FUIBaseDrawingView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface FUIChartLegendView : FUIDrawingView
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
/// important:
///
/// The <code>statusLabel</code> and <code>statusImageView</code> may not be displayed simultaneously.  When values exist for both <code>statusText</code> and <code>statusImage</code>,  <code>statusText</code> will take precedence.
@property (nonatomic, copy) NSString * _Nullable statusText;
/// Property defining the substatusLabel text.  An empty string value hides the subStatusLabel.
/// important:
///
/// The <code>subStatusLabel</code> and <code>subStatusImageView</code> may not be displayed simultaneously.  When values exist for both <code>subStatusText</code> and <code>subStatusImage</code>,  <code>subStatusText</code> will take precedence.
@property (nonatomic, copy) NSString * _Nullable subStatusText;
