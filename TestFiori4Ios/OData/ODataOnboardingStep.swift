...
// test
//
// Created by SAP Cloud Platform SDK for iOS Assistant application on 26/12/19
//
...
open class ODataOnboardingStep: OnboardingStep {
    ...
    private func configureOData(using context: OnboardingContext, completionHandler: @escaping (OnboardingResult) -> Void) {
        ...
        let configurationURL = URL(string: (context.info[.sapcpmsSettingsParameters] as! SAPcpmsSettingsParameters).backendURL.appendingPathComponent("com.sap.tutorials.demoapp.MyDeliveries").absoluteString)!
