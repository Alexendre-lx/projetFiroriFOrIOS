...
public class OnboardingFlowProvider: OnboardingFlowProviding {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: "com.sap.tutorials.demoapp.MyDeliveries", authenticationPath: "com.sap.tutorials.demoapp.MyDeliveries")
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            welcomeStepUI.headlineLabel.text = "com.sap.tutorials.demoapp.MyDeliveries"
